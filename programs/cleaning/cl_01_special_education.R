...
special_education_data <- read_csv("~/VCE_AI_TOOL/data/sources/Virginia-Department-of-Education/2022-2023_Special_Education_Child_Count.csv")
...
# write csv
write_csv(updated_data, here("data/outcome/Virginia-Department-of-Education/2022-2023_Special_Education_Child_Count.csv"))