* Encoding: UTF-8.
***********************************************************************************************************.
*     Program: Code_to_create_SCH_Directory_File_2021-22.sps                                              *.
...
FILE LABEL '[name your data file]'.                           
                                                                                                         /* replace [name your data file] with your own data file name  */
...
SAVE OUTFILE '[insert path]\[insert file name]' /COMPRESSED.   	
                                                                        	/* replace [insert path] and [insert file name] to save your own data file */
EXECUTE.
